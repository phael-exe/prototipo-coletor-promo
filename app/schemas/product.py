...
class ProductSchema(BaseModel):
    ...
    original_price: float | None = Field(None, description="Preço original antes do desconto")
    discount_percent: float | None = Field(None, description="Percentual de desconto calculado")
    seller: str | None = Field(None, description="Nome do vendedor ou loja oficial")
    image_url: str | None = Field(None, description="URL da imagem principal")
